<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategD.aspx.cs" Inherits="MwebSite.CategD" %>
       ...
       <div id="Div1" class="container" style="width:70%;margin:auto" runat="server">
        <div id="catList" runat="server">
          <asp:ImageButton CssClass="btn btn-default"  ID='ImageButton1' runat='server' ImageUrl='~/Images/w1.jpg' Width='100px' Height='100px' ToolTip='T-Shirt Category' PostBackUrl='~/CategA.aspx'/>
            ...
            <asp:ImageButton  CssClass="btn btn-primary" ID='ImageButton4' runat='server' ImageUrl='~/Images/w4.jpg' Width='100px' Height='100px' ToolTip='Shorts Category' PostBackUrl='~/CategD.aspx'/></div>
        <h1 style="text-align:center;color:red;margin-bottom:50px">Shorts</h1>
