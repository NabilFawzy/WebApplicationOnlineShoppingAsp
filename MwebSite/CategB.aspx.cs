...
namespace MwebSite
{
    public partial class CategB : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (var r in prodc)
            {
                if (r.catID == 2)
                {
                    ...
                    t.InnerHtml += ("<asp:Button runat='server'  Class='btn btn-default' id='Shirts" + r.productID + "' href='#'><img  src=Images/" + r.imageName + " style='width:200px; height:200px' runat='server'> <br/>");
