<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddProductByAdmin.aspx.cs" Inherits="MwebSite.AddProductByAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div id="catList" runat="server">
            ...
            <asp:Button CssClass="btn btn-primary" ID='ImageButton2' runat='server' Text="Add new Product" Width='163px' Height='100px' ToolTip='Shirt Category' PostBackUrl="~/AddProductByAdmin.aspx" CausesValidation="False"/>
         ...
         <br /><br /><br /><br /><br /><br />
              <input id="Tex1" class="form-control" runat="server" type="text" placeholder="Product Description" autocomplete="off">
               <asp:RequiredFieldValidator ID="RequiredFieldValidatorDes" runat="server" ErrorMessage="Description is required" ControlToValidate="Tex1" Font-Bold="True" Font-Italic="True" Font-Size="15px" ForeColor="#CC0000"></asp:RequiredFieldValidator>
           ...
           <input id="pricc" class="form-control" runat="server" type="text" placeholder="Product price "  autocomplete="off">
             ...
             <asp:FileUpload ID="FileUpload1" cssclass="form-control" runat="server" /><br /><br /><br />
