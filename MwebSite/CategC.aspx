<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategC.aspx.cs" Inherits="MwebSite.CategC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
       ...
       <div id="Div1" class="container" style="width:70%;margin:auto" runat="server">
         ...
         <asp:ImageButton CssClass="btn btn-default"  ID='ImageButton1' runat='server' ImageUrl='~/Images/w1.jpg' Width='100px' Height='100px' ToolTip='T-Shirt Category' PostBackUrl='~/CategA.aspx'/>
            ...
            <asp:ImageButton CssClass="btn btn-primary" ID='ImageButton3' runat='server' ImageUrl='~/Images/w3.jpg' Width='100px' Height='100px' ToolTip='Trousers Category' PostBackUrl='~/CategC.aspx'/>
        ...
        <h1 style="text-align:center;color:red;margin-bottom:50px">Trousers</h1>
